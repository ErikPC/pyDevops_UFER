...
ufer_schema_invalid_types = {
    "name": "Ufer Gold",
    "description": "Ufer Gold offers the most luxury experience in the entire galaxy. Includes all the features and amenities you can imagine.",
    "driver": "Autopilot",
    "passengers": 1,
    "privacy": "Private",
    "seats": "King Size",
...
@pytest.mark.test_validar_types
def test_validar_types():
    assert validate_value_types(ufer_schema_invalid_types) == False
    assert validate_value_types(ufer_schema_invalid_keys_and_types) == False
